...
<body>
    <div class="form">
        <div class="container">
            ...
            ?>
            <form action="professorRegister.php" method="post">
                <div class="form-group">
                    <input type="text" class="form-control" name="fullname" placeholder="Full Name:">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" name="facultyid" placeholder="Faculty Id:">
                </div>
                <div class="form-group">
            ...
            <div>
            <div><p>Already Registered <a href="professorLogin.php">Login Here</a></p></div>
        </div>
        </div>
    </div>
</body>
